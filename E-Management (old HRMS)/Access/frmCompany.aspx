<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="frmCompany.aspx.vb" Inherits="E_Management.frmCompany" 
...
<table align="center">
<tr><td colspan="2" align="center"  style="background: #5D7B9D; font-weight:bold; color:White; height: 20px;">
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Small" Text="Company Registration"></asp:Label></td></tr>
<tr><td>
    <asp:Label ID="Label1" runat="server" Text="Company"></asp:Label></td><td>
        <asp:TextBox ID="TxtBoxCompany" runat="server" MaxLength="50"></asp:TextBox></td></tr>
<tr><td style="height: 26px"></td><td style="height: 26px">
    <asp:Button ID="BtnSave" runat="server" Text="Add" /></td></tr>
    <tr><td runat="server" colspan="2">
        <asp:Label ID="LblMsg" runat="server" Font-Bold="True" Font-Size="Small"></asp:Label></td></tr>
        <tr><td colspan="2">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" DataKeyNames="company"
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:E_Management.My.MySettings.hrmisConnectionString %>"
        SelectCommand="Sp_GetCompanies" SelectCommandType="StoredProcedure"
        deletecommand="Sp_DelCompanies" DeleteCommandType="StoredProcedure">
        <DeleteParameters>
