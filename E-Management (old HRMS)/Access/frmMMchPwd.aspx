<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="frmMMchPwd.aspx.vb" Inherits="E_Management.frmMMchPwd" 
				...
				<tr>
					...
					<td vAlign="top" bgColor="#ffffff" style="width: 356px">
						<table width="100%">
							...
							<TR>
								<TD align="right" style="width: 421px; height: 26px;"><FONT style="FONT-SIZE: 12px; FONT-FAMILY: verdana">Confirm Password:</FONT></TD>
								<TD align="left" style="width: 199px; height: 26px;">
                                    <asp:TextBox ID="TxtCPwd" runat="server" TextMode="Password"></asp:TextBox></TD>
							</TR>
							<TR>
								<td style="width: 421px; height: 26px;"></td>
								<TD vAlign="top" align="left" style="width: 199px; height: 26px;">
							...
							<tr>
								<td colspan="2" align="center" style="height: 21px"></td>
							</tr>
							<tr>
								<td colspan="2" align="center"></td>
							</tr>
							<tr>
								<td colspan="2" align="center" style="height: 22px"></td>
							</tr>
							<tr>
