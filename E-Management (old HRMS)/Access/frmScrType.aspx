<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="frmScrType.aspx.vb" Inherits="E_Management.frmScrType" 
    title="Screen Type Registration" %>
...
<tr><td colspan="2" align="center"  style="background: #5D7B9D; font-weight:bold; color:White">
    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Small" Text="Screen Type Registration"></asp:Label></td></tr>
<tr><td>
    <asp:Label ID="Label1" runat="server" Text="Screen Type"></asp:Label></td><td>
        <asp:TextBox ID="TxtBoxScrType" runat="server" MaxLength="50" Width="275px"></asp:TextBox></td></tr>
        <tr><td>
    <asp:Label ID="Label3" runat="server" Text="Description (Optional)"></asp:Label></td><td>
        <asp:TextBox ID="TxtBoxScrTypeDesc" runat="server" MaxLength="4000" TextMode="MultiLine" Width="280px"></asp:TextBox></td></tr>
<tr><td></td><td>
    ...
    <tr><td id="Td1" runat="server" colspan="2">
        ...
        <tr><td colspan="2">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" DataKeyNames="ScrType"
        ...
        <Columns>
            <asp:BoundField DataField="ScrType" HeaderText="Screen Type" SortExpression="ScrType" />
            <asp:BoundField DataField="ScrTypedesc" HeaderText="Description" SortExpression="ScrTypedesc" />
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:E_Management.My.MySettings.hrmisConnectionString %>"
        SelectCommand="Sp_GetScrTypes" SelectCommandType="StoredProcedure"
        deletecommand="Sp_DelScrTypes" DeleteCommandType="StoredProcedure">
        <DeleteParameters>
            <asp:Parameter Name="ScrType" Type="String" />
        </DeleteParameters>
