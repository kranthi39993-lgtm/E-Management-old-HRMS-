...
Public Class Report_VehicleInformation
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Report_VehicleInformation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_VehicleInformation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_VehicleInformation = New Report_VehicleInformation
        rpt.Site = Me.Site
        Return rpt
    End Function
