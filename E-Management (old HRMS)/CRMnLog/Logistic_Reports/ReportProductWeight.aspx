<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportProductWeight.aspx.vb" Inherits="E_Management.ReportProductWeight" Title="Product Weight" %>
...
<body>
    ...
    <div>
        ...
        <br /><hr />
        Department:&nbsp;
        <asp:DropDownList ID="CmbDept" runat="server" Width="180px">
        </asp:DropDownList>&nbsp;
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="D:\E-Management\CRMnLog\Logistic_Reports\Report_WeightRegistration.rpt">
            </Report>
