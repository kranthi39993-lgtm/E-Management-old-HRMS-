...
Public Class Report_CustomerBillUploading
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Report_CustomerBillUploading.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_CustomerBillUploading
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_CustomerBillUploading = New Report_CustomerBillUploading
        rpt.Site = Me.Site
        Return rpt
    End Function
