...
Partial Public Class ReportCOCDateWise
    Inherits Messagebox
    Dim crReportDocument As Report_COCDateWise
...
#Region " Web Form Designer Generated Code "
    ...
    Private Sub Page_Init(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Init
        ...
        If IsPostBack = False Then
            ...
            crReportDocument = New Report_COCDateWise
...
#End Region
    ...
    Private Sub LoadReport()
        Try
            ...
            TmpDs = New DataSet()
            Cmd = New SqlCommand("SELECT  ApprovalStatus, COUNT(ApprovalStatus) AS Count FROM Log_COCSubmission  WHERE Createdon BETWEEN '" & Dt1 & "' AND '" & Dt2 & "' GROUP BY  ApprovalStatus", con1)
            ...
            Dim Str As String = Server.MapPath("Report_COCDateWise.rpt")
            Cr.Load(Str)
    ...
    Protected Sub Calendar2_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Calendar2.SelectionChanged
        ...
        TxtTo.Text = s
        Calendar2.Visible = False
        Label3.Text = "COC Status From " & Format(Convert.ToDateTime(Calendar1.SelectedDate), "dd/MM/yyyy") & " To " & Format(Convert.ToDateTime(Calendar2.SelectedDate), "dd/MM/yyyy")
    ...
    Protected Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            LoadReport()
            Cr.ExportToDisk(ExportFormatType.Excel, "\\192.168.0.242\\temp\\Logistic_Report\\COCGraph.xls")
            Label4.Text = "Successfully Exported, Please Check Given Location F:\\Temp\\Logistic_Report\\COCGraph.xls"

        Catch ex As Exception
            Label4.Text = "Please Provide Criteria Value"
        End Try
    End Sub
End Class