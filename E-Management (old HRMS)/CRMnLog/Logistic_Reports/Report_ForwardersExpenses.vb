...
Public Class Report_ForwardersExpenses
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Report_ForwardersExpenses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_ForwardersExpenses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_ForwardersExpenses = New Report_ForwardersExpenses
        rpt.Site = Me.Site
        Return rpt
    End Function
