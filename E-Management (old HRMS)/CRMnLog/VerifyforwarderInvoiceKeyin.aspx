<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VerifyforwarderInvoiceKeyin.aspx.vb" Inherits="E_Management.VerifyforwarderInvoiceKeyin" MasterPageFile="~/ems.Master" Title="Verify Forwarder Invoice" %>
                                ...
                                <table>
                                    <tr>
                                        <td colspan="2" style="background-color: #336699; text-align: center">
                                            <span style="font-size: 14pt; color: #ffffff"><strong>Verify / Reject Forwarder Invoice</strong></span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100px; text-align: left">
                                            Remarks</td>
                                        <td style="width: 100px; text-align: left">
                                            <asp:TextBox ID="TxtRemarks" runat="server" Height="55px" TextMode="MultiLine"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100px; text-align: left">
                                            <asp:Label ID="Label1" runat="server" Height="16px" Width="244px"></asp:Label></td>
                                        <td style="width: 100px; text-align: left">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <asp:Button ID="Button1" runat="server" Text="Verify" Width="81px" />
                                            <asp:Button ID="Button2" runat="server" Text="Reject" Width="81px" />&nbsp;<asp:Button
                                                ID="Button3" runat="server" Text="Exit" Width="68px" /></td>
                                    </tr>
                                </table>
