...
Partial Public Class VerifyForwarderInvoice
    ...
    Private Sub GridDisp()
        ...
        Cmd = New SqlCommand("SELECT UID,InvoiceNo, DepartmentName, FInvSubmissionDate, ForwarderName, ArrivalPlace, DepartPlace, ForwarderInvoiceNo, QuotedAmount, ForwarderInvoiceValue, Difference, Remarks FROM  Log_ForwarderInvoiceDetails Where VerifyStatus='Pending'", con1)
    ...
    Public Sub FunEdit(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        ...
        Response.Redirect("VerifyForwarderInvoiceKeyIn.aspx")

        'DGrid1.EditItemIndex = e.Item.ItemIndex
    ...
    Public Sub FunUpdate(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs)
        Try
            ...
            Cmd = New SqlCommand("Update Log_ForwarderInvoiceDetails Set VerifyStatus='Verified' Where UID=" & e.Item.Cells(0).Text, con1)
            Cmd.ExecuteNonQuery()
