...
Partial Public Class VerifyforwarderInvoiceKeyin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Cmd = New SqlCommand("SELECT UID,InvoiceNo, DepartmentName, FInvSubmissionDate, ForwarderName, ArrivalPlace, DepartPlace, ForwarderInvoiceNo, QuotedAmount, ForwarderInvoiceValue, Difference, Remarks FROM  Log_ForwarderInvoiceDetails Where VerifyStatus='Pending' and  UID=" & Session("refno"), con1)
        ...
        Else
            TxtDiff.BackColor = Drawing.Color.Lime
        End If
    ...
    Protected Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Cmd = New SqlCommand("Update Log_ForwarderInvoiceDetails Set VerifyStatus='Verified' , Remarks='" & TxtRemarks.Text & "'  Where UID=" & Session("refno"), con1)
            Cmd.ExecuteNonQuery()

            con1.Close()

            msg("Forwarder Invoice Verified")
            Response.Redirect("VerifyForwarderInvoice.aspx")
