<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ApprovalForwarderInvoice.aspx.vb" Inherits="E_Management.ApprovalForwarderInvoice" MasterPageFile="~/ems.Master" Title="Approval Screen" %>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <asp:DataGrid ID="DGrid1" runat="server" CellPadding="4" Width="321px" OnCancelCommand="FunCancel" OnEditCommand="FunEdit" OnUpdateCommand="FunUpdate" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None">
                                                ...
                                                <asp:EditCommandColumn CancelText="Reject" UpdateText="Verify" EditText="Approve / Reject" ButtonType="PushButton">
                                    ...
                                    <tr>
                                        <td style="width: 100px; height: 27px; text-align: center;">
                                            &nbsp;<asp:Button ID="Button1" runat="server" Text="Exit" Width="68px" /></td>
                                    </tr>
                                </table>
