...
Public Class AbnormalityRpttbyall
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AbnormalityRpttbyall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAbnormalityRpttbyall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AbnormalityRpttbyall = New AbnormalityRpttbyall
        rpt.Site = Me.Site
        Return rpt
    End Function
