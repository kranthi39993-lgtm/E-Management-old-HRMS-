<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Abnormalityrptall.aspx.vb" Inherits="E_Management.Abnormalityrptall" %>
...
<body>
    ...
    <div>
        ...
        <Report FileName="AbnormalityRpttbyall.rpt">
        </Report>
