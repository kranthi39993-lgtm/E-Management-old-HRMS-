...
Partial Public Class FiringMCTempChangePrint_Design
    Inherits System.Web.UI.Page

    Dim crReportDocument As FiringMCTempChangePrintDesign
...
#End Region
    ...
    Private Sub Loadreport1()
        ...
        Str = Server.MapPath("FiringMCTempChangePrintDesign.rpt")
    ...
    Private Sub CallReport()
        ...
        crReportDocument = New FiringMCTempChangePrintDesign
        ...
        crParameterDiscreteValue.Value = Session("Options").ToString
        crParameterValues.Add(crParameterDiscreteValue)
        crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)

        crParameterFieldDefinition = crParameterFieldDefinitions.Item(1)
        crParameterDiscreteValue = New ParameterDiscreteValue()
        crParameterDiscreteValue.Value = Session("BatchNo").ToString
        crParameterValues.Add(crParameterDiscreteValue)
        crParameterFieldDefinition.ApplyCurrentValues(crParameterValues)
