...
Public Class FiringReportsBydept
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "FiringReportsBydept.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFiringReportsBydept
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FiringReportsBydept = New FiringReportsBydept
        rpt.Site = Me.Site
        Return rpt
    End Function
