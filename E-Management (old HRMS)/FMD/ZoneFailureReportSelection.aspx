<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/ems.Master" CodeBehind="ZoneFailureReportSelection.aspx.vb" Inherits="E_Management.ZoneFailureReportSelection" 
    title="Zone Failure Reports" %>
                ...
                <table>
                    <tr>
                        <td colspan="2" style="width: 776px; border-bottom: 2px solid; height: 295px" valign="top">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 403px; height: 24px">
                                        <asp:DropDownList ID="mcnoddl" runat="server" DataSourceID="SqlDataSource2" DataTextField="Name"
                                            DataValueField="McNo" Width="194px">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                            ...
                            <asp:SqlDataSource ID="selsectreport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLfmd %>"
                                SelectCommand="SELECT McNo +'-'+ McName as Mcno,McName  FROM [Fir_FiringMcMaster] WHERE ([department] = @dept)&#13;&#10;">
                                <SelectParameters>
