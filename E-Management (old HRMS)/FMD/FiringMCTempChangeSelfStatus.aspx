<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FiringMCTempChangeSelfStatus.aspx.vb" Inherits="E_Management.FiringMCTempChangeSelfStatus" MasterPageFile="~/ems.Master"  Title="Temperature Change"%>
                ...
                <table width="500" >
                            ...
                            <table>
                                <tr>
                                    <td colspan="2" style="background-color: #336699">
                                        <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="White" Text="Close Status of Temperature Change - Maintenance" Width="750px"></asp:Label></td>
                                </tr>
                            <tr>
                 ...
                 <asp:BoundField DataField="BatchNo" HeaderText="BatchNo" />
                  <asp:BoundField DataField="TempChangeOn" HeaderText="Date" />
                   <asp:BoundField DataField="SMSMessage" HeaderText="Temperature_Change_Details_Change_and_Close"  />
                   <asp:BoundField DataField="Status" HeaderText="Status"  />
             
               <asp:TemplateField HeaderText="ChangedOn">
            <ItemTemplate>
