...
Public Class PrintMouldRepairData
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PrintMouldRepairData.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrintMouldRepairData
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintMouldRepairData = New PrintMouldRepairData
        rpt.Site = Me.Site
        Return rpt
    End Function
