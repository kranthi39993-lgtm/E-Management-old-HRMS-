...
Public Class PrintMouldRepairRequest
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PrintMouldRepairRequest.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SLNO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPrintMouldRepairRequest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrintMouldRepairRequest = New PrintMouldRepairRequest
        rpt.Site = Me.Site
        Return rpt
    End Function
