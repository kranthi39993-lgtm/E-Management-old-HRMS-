<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EditMouldDetails.aspx.vb" Inherits="E_Management.EditMouldDetails" MasterPageFile="~/ems.Master" title="Edit Mould Registration" %>
...
<table>
    <tr>
        <td colspan="1" style="height: 21px; background-color: #5d7b9d; text-align: center">
            <asp:ImageButton ID="ImageButton1" runat="server" Height="39px" ImageUrl="~/MMForms/images/back.jpg"
                Width="45px" /></td>
        <td colspan="6" style="background-color: #5d7b9d; text-align: center; height: 21px;">
            <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="White" Text="Edit Mould Details"></asp:Label></td>
    </tr>
<tr>
<td style="background-color: beige; height: 26px;">
    ...
    <td style="width: 126px; height: 26px;">
        ...
        <td style="height: 26px"><asp:Button ID="Button2" runat="server" Text="View" /></td>
<td style="background-color: beige; height: 26px;">
    <asp:Label ID="Label2" runat="server" Text="Product Name"></asp:Label></td><td style="height: 26px">
        ...
        <td style="height: 26px"><asp:Button ID="Button1" runat="server" Text="View" /></td>
</tr>
    <tr>
        <td>
        </td>
...
<td colspan="6" style="text-align: center">
        ...
        <asp:GridView id="GridView1" runat="server" Width="394px" ForeColor="#333333" GridLines="None" CellPadding="4" AutoGenerateDeleteButton="True" AutoGenerateColumns="False" DataKeyNames="Product,MouldName,MouldNo,FGID" AllowSorting="True" AllowPaging="True" DataSourceID="SqlDataSource2" AutoGenerateEditButton="True" PageSize="15">
        <Columns>
        <asp:BoundField DataField="FGID" HeaderText="FGID" ReadOnly="True" SortExpression="FGID" ></asp:BoundField>
            ...
            <asp:BoundField DataField="PressLimit" HeaderText="PressLimit" SortExpression="PressLimit"></asp:BoundField>
            <asp:BoundField DataField="StandByQty" HeaderText="StandByQty" SortExpression="StandByQty"></asp:BoundField>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MMaintenanceConnectionString2 %>"
        DeleteCommand="Delete From MouldMaster Where Product=@Product and MouldName=@MouldName and MouldNo=@MouldNo and FGID=@FGID and Status ='A'&#13;&#10;"
        SelectCommand="SelectAll_MouldMaster" SelectCommandType="StoredProcedure" UpdateCommand="Update MouldMaster Set PressLimit=@PressLimit  Where Product=@Product and MouldName=@MouldName and MouldNo=@MouldNo and FGID=@FGID &#13;&#10;Update MouldMaster Set StandByQty=@StandByQty  Where Product=@Product and FGID=@FGID &#13;&#10;">
        <DeleteParameters>
            <asp:Parameter Name="Product" />
            <asp:Parameter Name="MouldName" />
            <asp:Parameter Name="MouldNo" />
        ...
        <UpdateParameters>
            <asp:Parameter Name="PressLimit" />
            <asp:Parameter Name="Product" />
            <asp:Parameter Name="MouldName" />
            <asp:Parameter Name="MouldNo" />
            <asp:Parameter Name="FGID" />
            <asp:Parameter Name="StandByQty" />
        </UpdateParameters>
    </asp:SqlDataSource>
        </td>
        <td colspan="6" style="text-align: center">
