<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CovidAbnormalReport.aspx.vb" Inherits="E_Management.CovidAbnormalReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Covid 19 Weekly Declaration</title>
</head>
<body>
    ...
    <thead>
        <tr>
            <th style="height: 16px; text-align: right">
                <asp:LinkButton ID="LinkButton3" runat="server" ForeColor="Blue" Font-Names="Arial" Font-Size="9pt">COVID 19 Daily Report</asp:LinkButton>
                &nbsp; &nbsp;
        ...
        <tr>
            <th style="height: 16px; text-align: center">
                <asp:Label ID="Label1" runat="server" Font-Names="Arial" Font-Size="10pt" Text="Declaration - Abnormal Report - Weekly"></asp:Label>&nbsp;</th>                
        </tr>
        </thead>
        <tr>
                ...
                <asp:GridView AutoGenerateColumns=false ID="GridView2" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Names="Arial" Font-Size="8pt" ForeColor="Black" GridLines="Horizontal">
                 ...
                 <asp:BoundField DataField="UID" HeaderText="UID" ReadOnly="True" SortExpression="UID" Visible=False />
                  <asp:BoundField DataField="EmpCode" HeaderText="EmpCode" ReadOnly="True" SortExpression="EmpCode" />
                   ...
                   <asp:HyperLinkField DataNavigateUrlFields="UID" DataNavigateUrlFormatString="Covid19DeclarationView.aspx?uid={0}"
