<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ApplnFormView.aspx.vb" Inherits="E_Management.ApplnFormView" %>
...
<body>
    ...
    <thead>
        <tr>
            <th style="height: 16px; text-align: right" colspan="7">
   ...
   <tbody>
   <tr>
   <td style="height: 16px; text-align: LEFT" colspan="7">   
...
<tr><td colspan="7">
 ...
 <tr><td colspan="7">
   ...
   <asp:Label ID="Label12" runat="server" >LATARBELAKANG /PERSONAL PARTICULAR :</asp:Label><tr><td colspan="7">
...
<tr><td colspan="7">
    ...
    <tr>
    <td><asp:RadioButton class="form-control" text= "Malay" ID="chkmalay" runat="server" /></td>
    <td><asp:RadioButton class="form-control" text= "Indian" ID="chkindia" runat="server" /></td>
    <td><asp:RadioButton class="form-control" text= "Chinese" ID="chkchinese" runat="server" /> </td>
   <td> <asp:RadioButton class="form-control" text= "Others Nyatakan" ID="chkothers" runat="server" /> 
</td></tr>
<tr><td colspan="7">
    ...
    <tr><td colspan="7">
     ...
     <tr>
        ...
        <td> <asp:CheckBox class="form-control" text ="Tamil /Tamil" ID="chktamil" runat="server" /></td>
         <td><asp:CheckBox class="form-control" text ="Cina /Chinese" ID="chkchines" runat="server" /></td>
  ...
  <table align="center" width="60%"  class="table table-striped">    
    ...
    <asp:Label class="form-control" ID="Label34" runat="server" >PENGALAMAN /EXPERIENCE</asp:Label>
     ...
     <tr>
      ...
      <table align="center" width="60%"  class="table table-striped"> 
<tr>
     <th style="height: 16px; text-align: left" colspan="7">
   ...
   <tr><td colspan="7">
     ...
     <tr>
        <td><asp:RadioButton class="form-control" text="Kurang Dari 10 /Less than 10" ID="Chkcigar10" runat="server" /></td>
        <td> <asp:RadioButton class="form-control" text ="Antara 10-20 /Within 10-20" ID="Chkcigar20" runat="server" /></td>
        <td> <asp:RadioButton class="form-control" text ="Lebih dari 20 /More than 20" ID="Chkcigar30" runat="server" /></td>
         </tr>
   ...
   <tr><td colspan="7">
     ...
     <tr>
        <td><asp:RadioButton class="form-control" text="Kurang Dari 10 /Less than 10" ID="Chkless" runat="server" /></td>
        <td> <asp:RadioButton class="form-control" text ="Antara 10-20 /Within 10-20" ID="Chkwithin" runat="server" /></td>
        <td> </td>
         </tr>
...
<table align="center" width="60%"  class="table table-striped"> 
 ...
 <tr><td colspan="7">
        ...
        <tr>
        <td><asp:RadioButton  class="form-control" Text="Ya /Yes" ID="Rbdexpyes" runat="server" GroupName="5" Checked="true" /></td>
 ...
 <tr><td colspan="7">
        ...
        <tr>
        <td><asp:RadioButton  class="form-control" Text="Ya /Yes" ID="Rbdmedyes" runat="server" GroupName="6" Checked="true" /></td>
...
<table align="center" width="60%"  class="table table-striped"> 
 ...
 <table align="center" width="60%"  class="table table-striped"> 
  ...
  <tr><td colspan="7">
        ...
        <td><asp:RadioButton class="form-control" text ="Rabun Dekat /Near Sighted" ID="Chknear" runat="server" /></td>
        <td><asp:RadioButton class="form-control" text ="Rabun Jauh /Far Sighted" ID="Chkfar" runat="server" /></td>
        <td><asp:RadioButton class="form-control" text ="Rabun Warna /Colour Blind" ID="Chkblind" runat="server" /></td>
 ...
 <tr><td>
  ...
  <td><asp:RadioButton  class="form-control" Text="Tidak /No" ID="Rbdpregno" GroupName="9" runat="server" Checked="true"  /></td>
  </tr>
...
<table align="center" width="60%"  class="table table-striped"> 
  ...
  <tr>
    <td><asp:RadioButton  class="form-control" Text="Ya /Yes" ID="Rbdworkyes" runat="server" GroupName="13"  Checked="true"/></td>
  ...
  <asp:TextBox class="form-control" ID="Txtjoin" runat="server"></asp:TextBox>
  </td></tr>
...
<asp:TextBox class="form-control" ID="Txtemg" runat="server"></asp:TextBox>
...
<asp:TextBox class="form-control" ID="Txtsig" runat="server"></asp:TextBox>
 ...
 <table align="center" width="60%"  class="table table-striped">  
  <tr><td colspan="7">
  <asp:Label ID="Label72" runat="server" Text="LASAN PENEMUDUGA /INTERVIEWER COMMENT"></asp:Label>
...
<td><asp:TextBox class="form-control" ID="Txtempname3" runat="server"></asp:TextBox></td>
   ...
   <tr>
   <td> <asp:Button id="Button2" runat="server"  class="book-now-btn1"  text="Submit" ></asp:Button>
